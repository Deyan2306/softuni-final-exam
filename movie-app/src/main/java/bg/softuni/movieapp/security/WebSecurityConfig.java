    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/profile/settings", "/profile/movies", "/profile/tv-series").hasAnyRole(UserRoleEnum.ADMIN.name(), UserRoleEnum.USER.name())
                        .requestMatchers("/movie/**", "/tv-series/**").permitAll()
                        .requestMatchers("/admin/**").hasAnyRole(UserRoleEnum.ADMIN.name())
